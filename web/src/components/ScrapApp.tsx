...
function App() {
    ...
    const connectToSmartContract = async () => {
        ...
        if (typeof network === 'object' && network !== null) {
            ...
            const WalletProjContractConnection = await new ethers.Contract(config[network.chainId].WalletProj.address, WalletProj.abi, provider);

            setWalletProjContract(WalletProjContractConnection);

            console.log(WalletProjContractConnection);
        }
    }
